...
class ProductsRepository {
  static const _allProducts = <Product>[
    Product(
      ...
      id: 0,
      name: 'Vagabond sack Omaima',
      price: 120,
    ),
    Product(
      category: Category.accessories,
      id: 1,
      name: 'Stella sunglasses Omaima',
      price: 58,
    ),
    Product(
      category: Category.accessories,
      id: 2,
      name: 'Whitney belt Omaima',
      price: 35,
    ),
    Product(
      category: Category.accessories,
      id: 3,
      name: 'Garden strand Omaima',
      price: 98,
    ),
    Product(
      category: Category.accessories,
      id: 4,
      name: 'Strut earrings Omaima',
      price: 34,
    ),
    Product(
      category: Category.accessories,
      id: 5,
      name: 'Varsity socks Omaima',
      price: 12,
    ),
    Product(
      category: Category.accessories,
      id: 6,
      name: 'Weave keyring Omaima',
      price: 16,
    ),
    Product(
      category: Category.accessories,
      id: 7,
      name: 'Gatsby hat Omaima',
      price: 40,
    ),
    Product(
      category: Category.accessories,
      id: 8,
      name: 'Shrug bag Omaima',
      price: 198,
    ),
    Product(
      category: Category.home,
      id: 9,
      name: 'Gilt desk trio Omaima',
      price: 58,
    ),
    Product(
      category: Category.home,
      id: 10,
      name: 'Copper wire rack Omaima',
      price: 18,
    ),
    Product(
      category: Category.home,
